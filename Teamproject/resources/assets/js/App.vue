...
<script>
    export default {
        ...
        created(){
            ...
            this.$eventBus.$on('login_function', (userinfo)=> { //외부객체
                let uri = 'userlogin';
                let temp =  {
                    'kinds' : 'Login',
                ...
                this.axios.post(uri,temp).then( //서버로 http통신 요청
        ...
        methods: {
            login_opertion : function (login_type) { //로그인 결과 출력
                if(login_type){
...
<style>
    ...
    .slide-fade-leave-active {
        transition: all .8s cubic-bezier(1.0, 1, 1.8, 3.0);
    }
